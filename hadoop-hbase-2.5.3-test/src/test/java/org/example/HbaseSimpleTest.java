...
//        int zkPort = miniZooKeeperCluster.startup(new File(ZK_TMP_PATH));
        TestingServer testingServer = new TestingServer(12342, new File(ZK_TMP_PATH));
    ...
    public void testHBase2() throws Exception {
        try (Connection connection = ConnectionFactory.createConnection(hBaseConfig);
            ...
            table.setColumnFamily(new ColumnFamilyDescriptorBuilder.ModifyableColumnFamilyDescriptor(CF_DEFAULT.getBytes()).setCompressionType(Compression.Algorithm.NONE));
