...
public class HbaseRestLocalCluster implements MiniCluster {
    ...
    public void start() throws Exception {
        ...
        sh.setInitParameter("jersey.config.server.provider.classnames", ResourceConfig.class.getCanonicalName());
        ...
        ServletContextHandler servletContextHandler = ServletContextHandler.getServletContextHandler(context.getServletContext());

        HttpServerUtil.constrainHttpMethods(servletContextHandler, true);
//        HttpServerUtil.constrainHttpMethods(context.getServletHandler(), true);
