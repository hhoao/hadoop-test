...
public class HiveTableSink implements DynamicTableSink, SupportsPartitioning, SupportsOverwrite {
    ...
    private TableMetaStoreFactory msFactory(boolean autoGatherStatistic) {
        return (TableMetaStoreFactory)
                SecurityObjectProxy.createInstance(
                        securityOperator,
                        new HiveTableMetaStoreFactory(
                                jobConf,
                                fsFactory(),
                                hiveVersion,
    ...
    private BucketsBuilder<RowData, String, ? extends BucketsBuilder<RowData, ?, ?>>
        ...
        OnCheckpointRollingPolicy<RowData, String> onCheckpointRollingPolicy =
                OnCheckpointRollingPolicy.build();
        return new HadoopPathBasedBulkFormatBuilder<>(
                        new Path(sd.getLocation()),
                        (HadoopPathBasedBulkWriter.Factory<RowData>)
                                SecurityObjectWithSecurityReturnObjectProxy.createInstance(
                                        securityOperator,
                                        hadoopBulkFactory,
                                        new Class[] {HadoopPathBasedBulkWriter.Factory.class}),
                        (HadoopFileCommitterFactory)
                                SecurityObjectWithSecurityReturnObjectProxy.createInstance(
                                        securityOperator,
                                        new DefaultHadoopFileCommitterFactory(),
                                        new Class[] {HadoopFileCommitterFactory.class}),
                        jobConf,
                        assigner,
