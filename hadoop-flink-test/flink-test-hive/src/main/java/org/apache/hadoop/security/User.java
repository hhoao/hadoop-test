...
/**
 * Save the full and short name of the user as a principal. This allows us to have a single type
 * that we always look for when picking up user names.
 */
    ...
    public User(String name, AuthenticationMethod authMethod, LoginContext login) {
        try {
            ...
            throw new IllegalArgumentException(
                    "Illegal principal name " + name + ": " + ioe.toString(), ioe);
        }
        fullName = name;
