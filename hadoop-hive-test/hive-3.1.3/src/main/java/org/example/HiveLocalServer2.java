...
//        hiveConf.setVar(HiveConf.ConfVars.METASTOREWAREHOUSE, new
// File(hiveWarehouseDir).getAbsolutePath());
//        hiveConf.setBoolVar(HiveConf.ConfVars.HIVE_IN_TEST, true);
//        hiveConf.setVar(HiveConf.ConfVars.HIVE_SERVER2_THRIFT_BIND_HOST,
// String.valueOf(hiveServer2Hostname));
...
//
//        File coreSite = new File(ClassLoader.getSystemClassLoader().getResource("").getFile(),
// "hive-site.xml");
...
//        FileUtils.deleteFile(hiveScratchDir);
...
//                throw new IllegalArgumentException("ERROR: Missing required config: Hive Server2
// Hostname");
//            }
//
...
//                throw new IllegalArgumentException("ERROR: Missing required config: Hive Meta
// Store Hostname");
//            }
//
...
//                throw new IllegalArgumentException("ERROR: Missing required config: Hive Scratch
// Dir");
//            }
//
//            if (hiveLocalServer2.hiveWarehouseDir == null) {
//                throw new IllegalArgumentException("ERROR: Missing required config: Hive Warehouse
// Dir");
//            }
//
...
//                throw new IllegalArgumentException("ERROR: Missing required config: Zookeeper
// Quorum");
//            }
//        }
//
