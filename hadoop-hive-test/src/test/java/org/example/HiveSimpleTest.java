...
public class HiveSimpleTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        LOG.info(String.format("HiveServer2 current state is %s, waiting...", serviceState.toString()));
    ...
    @Test
    public void testCrud() throws SQLException, IOException, ClassNotFoundException, InterruptedException {
        Class.forName("org.apache.hive.jdbc.HiveDriver");
        String user = System.getenv("USER");
        int intVar = hiveConf.getIntVar(HiveConf.ConfVars.HIVE_SERVER2_THRIFT_PORT);
        Connection con = DriverManager.getConnection("jdbc:hive2://localhost:" + intVar + "/default", user, "");
        ...
        String createTablePrepareStatement = "CREATE TABLE %s (userid INT,movieid INT,rating INT,unixtime STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY '\\t' STORED AS TEXTFILE";
        ...
        fileSystem.copyFromLocalFile(new Path(Objects.requireNonNull(resource).getFile()), new Path("/tmp/u.data"));
