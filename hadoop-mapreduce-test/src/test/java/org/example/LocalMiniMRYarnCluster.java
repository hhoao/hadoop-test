...
public class LocalMiniMRYarnCluster extends MiniYARNCluster{
    ...
    public LocalMiniMRYarnCluster(String testName) {
        this(testName, 1);
    }

    @SuppressWarnings("deprecation")
    public LocalMiniMRYarnCluster(String testName, int noOfNMs) {
        this(testName, noOfNMs, false);
    }
    @Deprecated
    public LocalMiniMRYarnCluster(String testName, int noOfNMs, boolean enableAHS) {
